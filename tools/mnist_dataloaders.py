...
from torchvision.datasets import KMNIST, MNIST, FashionMNIST, SVHN, CIFAR10
...
def get_dataloaders(batch_size: int) \
    ...
    dataloaders = [(10, get_train_val_test_split_dataloaders(torch_data_path=torch_data_path,
